...
const Pagination = ({ currentPage, totalPages = 6 }: PaginationProps) => {
  const progressWidth = totalPages > 1 ? ((currentPage - 1) / (totalPages - 1)) * 100 : 0;
            ...
            <div key={pageNumber} className="relative z-10">
              <div
                className={`
                  ...
                  select-none /* Evita a seleção de texto */
                  ${getStepClasses()}
                `}
              >
