    ...
    <div className="w-full h-full flex flex-col justify-center items-center p-4">
      <div className="w-full max-w-3xl">
        ...
        <div className="mt-10 text-center">
          <button className="w-full sm:w-auto px-8 py-3 bg-blue-800 text-white font-semibold rounded-lg shadow-md hover:bg-blue-900 transition-colors cursor-pointer disabled:opacity-50" onClick={() => setCurrentPage(6)} disabled={!isFormValid}>
            Próximo passo
          </button>
        </div>
      </div>
